...
export class EditarCentro implements OnInit{
    ...
    editarCentro(idCentro: number, formControl: FormGroup){
        ...
        const idsDepartamentos = departamentos.map(dep => { return dep.id_departamento!});
        ...
        this._centroService.editCentro({idCentro, nombre, localizacion, idsDepartamentos}).subscribe((centro) => {
            console.log(centro);
        })
