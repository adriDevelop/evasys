...
import { WEIGHTSSOPORTE } from '../../../core/environments/data-results';

@Component({
  selector: 'app-soporte-form-component',
  imports: [
    FormsModule,
    ReactiveFormsModule,
  ...
  styleUrl: './soporte-form-component.css',
})
export class SoporteFormComponent {
  ...
  private calcularResultadoSeccion(sectionKey: string): void {
    ...
    if (!formGroup) return;
    const pesosActuales = WEIGHTSSOPORTE;
